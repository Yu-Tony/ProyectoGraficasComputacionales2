...
struct TexturaTerreno {
	...
	TexturaTerreno(WCHAR* diffuseMap, WCHAR* normalMap) {
...
private:
	...
	ID3D11ShaderResourceView* colorMap0;
...
public:
	...
	bool CargaParametros(TexturaTerreno* map0,TexturaTerreno* map1, TexturaTerreno* map2, const wchar_t* heightTex, const wchar_t* mapaBlending, float tile)
	{
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, map1->diffuseMap, 0, 0, &colorMap1, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, map1->normalMap, 0, 0, &normalMap1, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, map2->diffuseMap, 0, 0, &colorMap2, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, map2->normalMap, 0, 0, &normalMap2, 0);
...
private:
	...
	void LoadHeightData(const wchar_t* heightTex)
	{
		...
		//estructura de una imagen o textura
